...
library(knitr)
include_graphics("images/monthly_temps.png")
```
...
**Note**: If you get an error about `ggplot_add` then try [this link](https://github.com/thomasp85/patchwork/issues/31) which suggests you run devtools::install_github("r-lib/rlang", build_vignettes = TRUE) before rerunning install.packages("gghighlight")
...
include_graphics("images/shootings.png")
```
