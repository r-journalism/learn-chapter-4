...
library(knitr)
include_graphics("images/gg1.png")
```
...
include_graphics("images/gg1c.png")
```

```{r img3, echo = F, out.width="100%"}
include_graphics("images/gg2.png")
```
...
include_graphics("images/gg2c.png")
```
...
include_graphics("images/gg2d.png")
```
...
include_graphics("images/gg2e.png")
```
...
include_graphics("images/gg3.png")
```
...
include_graphics("images/gg3c.png")
```
...
include_graphics("images/gg4.png")
```
...
include_graphics("images/gg4c.png")
```
...
include_graphics("images/gg5.png")
```
...
```{r img12, echo = F, out.width="100%"}
include_graphics("images/wide.png")
```
...
```{r img14, echo = F, out.width="100%"}
include_graphics("images/aes.png")
```
...
```{r img15, echo = F, out.width="100%"}
include_graphics("images/autocolor.png")
```
...
**Note**: Take a moment to appreciate how easy this was. This is a pain in the ass in other languages, like D3. 
